...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "What makes Beau Monde Builders different from other luxury home builders in Space Coast?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Beau Monde Builders primarily serves Space Coast, Melbourne, and Brevard County, Florida. We specialize in oceanfront estates, waterfront properties, and luxury custom homes throughout South Florida."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "You can schedule a private consultation by calling (321) 298-4122, emailing ajhoover@mac.com, or visiting our office at 1129 Rockledge Blvd, Rockledge, FL 32955. Our office hours are Monday through Friday 9:00 AM to 5:00 PM, with Saturday appointments available by request."
      }
    }
  ]
};
...
export const SEO = ({
  ...
  canonical,
  type = "website",
  image = "https://bmb-space-coast.lovable.app/og-image.jpg",
  noIndex = false,
}: SEOProps) => {
  ...
  return (
    <Helmet>
      ...
      <meta name="geo.placename" content="Space Coast" />
